...
dns_servers=(
    ...
    ["AE"]="217.172.224.47 194.150.168.168"
    # ... 添加其他国家的DNS服务器
)
        ...
        "PH"|"VN"|"MY"|"TH"|"ID"|"TW"|"HK"|"JP"|"US"|"DE"|"SG"|"AE")
            ...
            if check_custom_dns; then
                ...
                if [ $? -eq 0 ]; then
                    ...
                    echo "\e[1;32m该脚本适配于“\e[0m\e[1;31mCentos操作系统\e[0m\e[1;31m”\e[0m"
            ...
            ;;
        *)
            echo -e "\e[1;32m该脚本适配于“\e[0m\e[1;31mCentos操作系统\e[0m\e[1;31m”\e[0m"
            exit 1
            ;;
    esac
}
